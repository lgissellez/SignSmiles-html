# SignSmiles-html ![CI status](https://i.imgur.com/9OeHzzVs.jpg)
...
## Como funciona SignSmiles
 SignSmiles tiene dos opciones de vista:
 * Viste para oyentes: el usuario buscara por medio de palabras las señas  que busca.
